...
const Home = () => {
  return (
    <nav className='flex h-auto justify-between bg-[#fff]'>
      ...
      <div className='p-5 bg-[#fff] flex flex-col border-r-2'> <div className='flex justify-evenly'><AiOutlineStar /> 5.0</div><a href='/' className='underline'>10 Reviews</a><div></div></div>
